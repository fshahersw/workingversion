...
4. [Discovery overview](discovery/DISCOVERY-WORKFLOW-REVIEW.md): actual tabs, shared architecture, prioritized findings, performance plan and quality gates. For a forward-looking design that maps the court discovery lifecycle (FRCP 26–37) onto the Workflows engine and specifies concrete end-to-end workflows, see [End-to-end discovery workflows](discovery/END-TO-END-DISCOVERY-WORKFLOWS.md).
