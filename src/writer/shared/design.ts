...
export const DESIGN_BRIEF = [
  ...
  "Finish: audit_document runs when you finish an editing run and lists what is still off with the tool that fixes it; act on it before the receipt. For the visual questions it cannot answer (overflow, page balance, spacing) use view_page. Name the style you applied in your closing summary.",
].join("\n");
