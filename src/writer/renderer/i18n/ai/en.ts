...
export const en = {
  aiEmptyDraftTitle: "Start with a draft.",
  aiEmptyDraftBody1: "Describe the document, or attach your notes.",
  aiEmptyDraftBody2: "Requested changes appear directly on the page.",
  ...
  aiStarterFillTemplate: "Identify the unfilled placeholders. Ask for missing information rather than inventing it.",
  aiGskLoginBtn: "Connection settings",
  aiPanelTitle: "Writing partner",
  aiOpenAssistant: "Open writing partner",
  ...
  aiAskBtn: "Ask",
  aiAskTitle: "Ask about the selection",
  ...
  aiSwitchModelTitle: "Work depth",
  aiNewChatTitle: 'New chat',
  aiCollapseTitle: 'Collapse panel',
  aiHistorySep: '—— Earlier conversation ——',
  aiEmptyTitle: "Keep the work on the page.",
  aiEmptyBody1: "Draft, ask a question, or review the record.",
  aiEmptyBody2: "Select a passage to focus the request.",
  aiStarterWeeklyReport: "Create a short report from my notes, with a comparison table. No cover page.",
  aiStarterLaunchPost: "Draft a memorandum from the attached sources. Flag missing information.",
  aiStarterEventOutline: "Create a plain letter with editable recipient and signature fields.",
  aiThinking: 'Thinking',
  ...
  aiCreditsExhausted: 'The writing service is unavailable. Check the connection settings.',
