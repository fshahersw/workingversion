import {OfficeHeader} from '../../web/host/Header';
...
export function App() {
  ...
  return (
    <div className="app">
      <ToastHost />
      <Ribbon
        trailingActions={<OfficeHeader inline onLibrary={()=>{setShowAi(true);window.setTimeout(()=>window.dispatchEvent(new Event('sw-open-library')),50)}}/>}
        hasDoc={!!slide}
        deckEmpty={deckEmpty}
