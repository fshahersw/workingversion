...
// Platform build: the monorepo-relative path is resolved through the package alias.
import { layoutShapes, type SmartArtLayout } from '@genoffice/pptx-engine/smartart-layout'
