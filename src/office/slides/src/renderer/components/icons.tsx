...
export function GensparkMark({ size = 30 }: { size?: number }) {
  return <svg width={size} height={size} viewBox="0 0 32 32" aria-hidden="true"><text x="1" y="22" fill="currentColor" fontFamily="Arial,sans-serif" fontWeight="700" fontSize="18" letterSpacing="-1">SW</text></svg>
}
