...
export const en = {
  ...
  aiGensparkAccount: 'Workbook assistant account',
  aiAccountChecking: 'Checking…',
  aiLoggedIn: 'Signed in',
  aiLoggedInAs: 'Signed in: {email}',
  aiNotLoggedIn: 'Not signed in (AI features require a Workbook assistant account)',
  aiWaitingBrowserLogin: 'Waiting for browser sign-in…',
  aiLoginGenspark: 'Sign in to Workbook assistant',
  aiModel: 'Model',
  aiCancel: 'Cancel',
  aiSave: 'Save',
  ...
  aiCreditsExhausted:
    'Your Workbook assistant credits have run out. Visit genspark.ai/pricing to top up, then try again',
