import type { WriterStatus } from './sw-policy'
import { z } from 'zod'
...
export interface DesktopApi {
  swNewWorkbook(): Promise<void>
  swStatus(): Promise<WriterStatus>
  swOpenConfig(): Promise<WriterStatus>
  swTestConnection(): Promise<WriterStatus>
  swApproveResearch(question: string): Promise<string>
