...
const desktopApi: DesktopApi = {
  swNewWorkbook: () => ipcRenderer.invoke('sw:new-workbook'),
  swStatus: () => ipcRenderer.invoke('sw:status'),
  swOpenConfig: () => ipcRenderer.invoke('sw:open-config'),
  swTestConnection: () => ipcRenderer.invoke('sw:test'),
  swApproveResearch: (q) => ipcRenderer.invoke('sw:approve-research', q),
