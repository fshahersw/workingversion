...
import { currentState, researchAvailable, subscribe } from "./session";
...
export function SwControls({ preferences, busy, onChange }: Props) {
  ...
  const tabs: ReadonlyArray<readonly [Preferences["swMode"], string]> = [
    ...
    ["ask", "Ask"],
    ["review", "Review"],
    ...(research ? [["research", "Research"] as const] : []),
  ];
  return (
    <>
