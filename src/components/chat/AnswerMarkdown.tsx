  ...
  return (
    <div
      className={[
        ...
        "[&_h1]:mt-0 [&_h1]:mb-3 [&_h1]:text-[19px] [&_h1]:font-semibold [&_h1]:tracking-tight [&_h1]:text-brand-navy",
        "[&_h2]:mt-6 [&_h2]:mb-2.5 [&_h2]:text-[15.5px] [&_h2]:font-semibold [&_h2]:tracking-tight [&_h2]:text-brand-navy [&_h2]:border-b [&_h2]:border-border [&_h2]:pb-1",
        "[&_h3]:mt-5 [&_h3]:mb-1.5 [&_h3]:text-[13px] [&_h3]:font-semibold [&_h3]:uppercase [&_h3]:tracking-[0.06em] [&_h3]:text-brand-navy/85",
        "[&_p]:my-3 [&_p]:leading-[1.6]",
        "[&_strong]:font-semibold [&_strong]:text-brand-navy",
        "[&_em]:text-foreground/80",
        "[&_ul]:my-3 [&_ul]:list-disc [&_ul]:pl-5 [&_ul]:space-y-1 [&_ul]:marker:text-brand-navy/40",
        "[&_ol]:my-3 [&_ol]:list-decimal [&_ol]:pl-5 [&_ol]:space-y-1 [&_ol]:marker:text-brand-navy/60 [&_ol]:marker:font-semibold",
        "[&_li]:pl-1 [&_li]:leading-[1.55]",
        "[&_a]:text-primary [&_a]:underline-offset-2 hover:[&_a]:underline [&_a]:break-words",
        "[&_blockquote]:my-3.5 [&_blockquote]:border-l-2 [&_blockquote]:border-brand-orange/60 [&_blockquote]:bg-brand-orange-soft/30 [&_blockquote]:px-3 [&_blockquote]:py-1 [&_blockquote]:text-[13.5px] [&_blockquote]:text-foreground/85",
