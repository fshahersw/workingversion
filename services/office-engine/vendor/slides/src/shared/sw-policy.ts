...
const READ = ['read_slide','load_guide','read_attachment','list_slide_templates','audit_layout','list_style_templates']
const WRITE = [...READ,'execute_slide_script','add_slide','edit_table_style','edit_chart','apply_ops','save_style_template','create_presentation']
